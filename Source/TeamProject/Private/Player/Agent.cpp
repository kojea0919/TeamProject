...
AAgent::AAgent()
{
	...
	static ConstructorHelpers::FObjectFinder<USkeletalMesh> SK_AGENT(TEXT("/Game/_GamePlay/Player/SHIROKO/SHIROKO_SkeletaMesh.SHIROKO_SkeletaMesh"));
	...
	static ConstructorHelpers::FObjectFinder<UInputAction> IA_JUMP(TEXT("/Game/_GamePlay/Player/Input/IA_Jump.IA_Jump"));
